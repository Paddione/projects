...
mkdir -p "${ROOT_DIR}/voice-models"
mkdir -p "${ROOT_DIR}/tts-output"
...
echo ""
echo "Voice models are stored in: ${ROOT_DIR}/voice-models/"
echo "Audio output is stored in: ${ROOT_DIR}/tts-output/"
echo ""
