...
`;
  ...
  describe('loadConfig', () => {
    ...
    it('should throw error for non-existent config file', () => {
      ...
      (TestConfigManager as any).instance = null;
  ...
  describe('getEnvironmentConfig', () => {
    ...
    it('should throw error for non-existent environment', () => {
      expect(() => configManager.getEnvironmentConfig('nonexistent' as any)).toThrow('Environment configuration not found');
    });
  });
  ...
  describe('getTestTypeConfig', () => {
    ...
    it('should throw error for non-existent test type', () => {
      expect(() => configManager.getTestTypeConfig('nonexistent' as any)).toThrow('Test type configuration not found');
    });
  });
