...
import { BlueGreenConfig } from './BlueGreenDeployment.js';
...
export const STAGING_BLUE_GREEN_CONFIG: BlueGreenConfig = {
...
export const PRODUCTION_BLUE_GREEN_CONFIG: BlueGreenConfig = {
  ...DEFAULT_BLUE_GREEN_CONFIG,
  loadBalancer: {
    ...DEFAULT_BLUE_GREEN_CONFIG.loadBalancer,
...
export const CANARY_BLUE_GREEN_CONFIG: BlueGreenConfig = {
