#!/usr/bin/env node
import { initializeErrorHandling, errorHandler, healthMonitor, notificationService } from './index.js';
/**
...
async function testErrorHandling() {
    ...
    try {
        ...
        await notificationService.sendAlertNotification('Test Alert', 'This is a test alert to verify the notification system is working', 'medium', { testRun: true });
        await notificationService.sendCustomNotification('Test Custom Notification', 'This is a custom notification for testing purposes', 'low', ['slack'], { testRun: true });
