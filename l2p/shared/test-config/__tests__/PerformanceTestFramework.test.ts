...
describe('PerformanceTestFramework', () => {
  ...
  test('should create load test scenarios', () => {
    ...
    const scenarios = (performanceFramework as any).getLoadTestScenarios();
  ...
  test('should validate performance thresholds', () => {
    ...
    const result = (performanceFramework as any).checkThresholds(mockMetrics, mockThresholds);
  ...
  test('should detect performance regression', () => {
    ...
    const regression = (performanceFramework as any).detectRegression(currentMetrics, baselineMetrics);
  ...
  test('should create Artillery configuration', () => {
    ...
    interface MockContext {
      ...
      environment_config: {
        services: {
          backend: { port: number; health_endpoint: string; timeout: number; base_url: string };
        };
      };
      test_type_config: Record<string, unknown>;
    ...
    const config = (performanceFramework as any).createArtilleryConfig(mockScenario, mockContext) as string;
  ...
  test('should calculate average values correctly', () => {
    ...
    const average = (performanceFramework as any).calculateAverage(values) as number;
  ...
  test('should calculate CPU usage correctly', () => {
    ...
    const cpuUsage = (performanceFramework as any).calculateCpuUsage(cpuMetrics) as number;
  ...
  test('should handle empty metrics gracefully', () => {
    const emptyMetrics = (performanceFramework as any).getEmptyMetrics() as any;
