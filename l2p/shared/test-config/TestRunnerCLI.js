 ...
 */
async function watchTests(testType, options) {
 ...
 */
async function generateReport(options, inputFile) {
    if (!inputFile) {
 ...
 */
function getOptions(cmdOptions) {
    ...
    return {
        ...
        formats: globalOptions.formats.split(','),
