...
async function demonstrateBlueGreenDeployment() {
    ...
    try {
        ...
        const deploymentResult = await blueGreenDeployment.deploy(STAGING_TARGET, 'v1.2.3', buildResult.artifacts);
...
export { demonstrateBlueGreenDeployment, demonstrateProductionDeployment, demonstrateNginxConfiguration };
