...
export class TestCLI {
    ...
    async runAllTests(options) {
        ...
        try {
            ...
            // Parse skip options
            const skipTypes = options.skip ? options.skip.split(',').map((t) => t.trim()) : [];
     ...
     */
    async startEnvironment(options) {
     ...
     */
    async resetEnvironment(options) {
     ...
     */
    async checkEnvironmentStatus(options) {
     ...
     */
    async viewEnvironmentLogs(options) {
        try {
     ...
     */
    async showCoverageSummary(options) {
        try {
    ...
    async troubleshootFailingTests() {
    ...
    async generateJestConfig(options) {
        try {
