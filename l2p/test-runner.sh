...
# Location: repo root (test-runner.sh)
...
PLAYWRIGHT_TEST_DIR="${SCRIPT_DIR}/frontend/e2e/tests"
PLAYWRIGHT_CONFIG="${SCRIPT_DIR}/frontend/playwright.config.ts"
PLAYWRIGHT_REPORT_DIR="${SCRIPT_DIR}/frontend/e2e/playwright-report"
...
print_usage() {
  cat <<'EOF'
Usage: ./test-runner.sh [--help] [--list] [--run <key> [skip-build]]
